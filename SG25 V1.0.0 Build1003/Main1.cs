...
//            DoorsDownAutoTh();
        ...
        private void CycleRun_DoWork(System.Object sender, System.ComponentModel.DoWorkEventArgs e)
      {
          do
          {
              ...
              if (Class1.RunStep == 1)
              {
                  ...
                  //{
                      if (Class1.PumpTick <= 10)
                      {
                          ...
                          {
                              CycleFirstTL = true;
                              //Class2.Create10DOArray(29,0,28,1);
              ...
              if (Class1.RunStep == 11)
              {
                  ...
                  //Class2.Create10DOArray(5, 0, 17, 0); //Close RF ON & Pressure Valve
              ...
              {
                  Thread.Sleep(50);
                  //Class2.Create10DOArray(5, 0, 6, 1, 10, 0, 11, 0, 7, 0); //Pressure Valve off & Purge Valve On & Gas1 Off & Gass 2 Off & VacVAlve Off
      ...
      private void Button8_Click(System.Object sender, System.EventArgs e)
               ...
               //(int)Class1.R_RFT;
                ...
                if (Class1.AlarmPause == true & Class1.TLDid1 == false)
                {
                   ...
                   // Class2.Create10DOArray(28, 0, 29, 0, 27, 1, 30, 1);
                    ...
                    Class2.SetDO(Class1.DIOSlotNum, Class1.DO27, false);//Turn off yellow light
                    Class2.SetDO(Class1.DIOSlotNum, Class1.DO26, false);//Turn off green light
                    Class2.SetDO(Class1.DIOSlotNum, Class1.DO28, true);//Turn on red light
                    Class2.SetDO(Class1.DIOSlotNum, Class1.DO29, true);//Turn on Buzzer

                    //Class2.Create10DOArray(28, 0);     //Turn off yellow light
                    //Class2.Create10DOArray(29, 0);    //Turn off green light
                    //Class2.Create10DOArray(27, 1);    //Turn on red light
                    //Class2.Create10DOArray(30, 1);  //Turn on Buzzer
                }
                ...
                if (Class1.AlarmPause == false & Class1.TLDid2 == false)
                {
                   ...
                   // Class2.Create10DOArray(27, 0, 30, 0, 28, 1);
                    Class2.SetDO(Class1.DIOSlotNum, Class1.DO28, false);//Turn off red light
                    Class2.SetDO(Class1.DIOSlotNum, Class1.DO29, false);//Turn off Buzzer
                    Class2.SetDO(Class1.DIOSlotNum, Class1.DO27, true);//Turn on yellow light
                    //Class2.Create10DOArray(27, 0);   //Turn off red light
                    //Class2.Create10DOArray(30, 0);  //Turn off Buzzer
                    //Class2.Create10DOArray(28, 1);//Turn on yellow light
                    Class1.HoldBuzzer = false;
                }

               if(Class1.CycleStart==true & CycleS==false & Class1.AlarmPause==false)
                { 
                    //Class2.Create10DOArray(27, 0, 28, 0, 29, 1);
        ...
        private object SetDo()
        {
            Thread.Sleep(10);
            Int32 ret = default(Int32);
            Int32 buf = 0;

            string ans = BinaryToDecimal(DOArray);
        ...
        private string BinaryToDecimal(string binar)
        {
        ...
        private void VentNow()
        {
            ...
            //Class2.Create10DOArray(17, 0, 7, 0, 10, 0, 11, 0,13,1);
