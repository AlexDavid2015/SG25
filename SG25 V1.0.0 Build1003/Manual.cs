       ...
       // int moduleDIDO = 3;
        ...
        private void Button12_Click(System.Object sender, System.EventArgs e)
        {
          ...
          //  }
            ...
            {
                Thread.Sleep(200);
                //Class2.Create10DOArray(10, 0, 11,0);
        ...
        private void StopManualRun_RunWorkerCompleted(System.Object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
           ...
           Thread.Sleep(200);
          // Class2.Create10DOArray(17, 0, 7,0, 10,0, 11,0, 20,0);   //Close RF ONto go 
        ...
        private void ValueReadBW()
        {
            ...
            do
            {
                ...
                else
                {
                    ...
                    Plasma.Invoke((MethodInvoker)delegate { Plasma.Visible = true; Plasma.BringToFront(); VacValve.BringToFront(); Press2.BringToFront(); });
