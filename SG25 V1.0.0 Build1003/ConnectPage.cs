    ...
    public partial class ConnectPage : Form
    {
        ...
        private void ConnectPage_Activated(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (i = 0; i < 8; i++)
                {
                    txtAOOutputVals[i].Text = "";
                    AOTrackBarVals[i].Value = 0;
                }
            }
        }
        ...
        public void IO_UI_Arrays_Assign()
        {
            ...
            // Assign AO High Vals
            AOHighVals[0] = lblRFSET_0High;
            AOHighVals[1] = lblTNSET_1High;
            AOHighVals[2] = lblLDSET_2High;
            AOHighVals[3] = lblG1SET_3High;
            AOHighVals[4] = lblG2SET_4High;
            AOHighVals[5] = lblSPARE_5High;
            AOHighVals[6] = lblSPARE_6High;
            AOHighVals[7] = lblSPARE_7High;

            // Assign AO Low Vals
            AOLowVals[0] = lblRFSET_0Low;
            AOLowVals[1] = lblTNSET_1Low;
            AOLowVals[2] = lblLDSET_2Low;
            AOLowVals[3] = lblG1SET_3Low;
            AOLowVals[4] = lblG2SET_4Low;
            AOLowVals[5] = lblSPARE_5Low;
            AOLowVals[6] = lblSPARE_6Low;
            AOLowVals[7] = lblSPARE_7Low;

            // Assign AO Output label Vals
            AOOutputVals[0] = lblRFSET_0Value;
            AOOutputVals[1] = lblTNSET_1Value;
            AOOutputVals[2] = lblLDSET_2Value;
            AOOutputVals[3] = lblG1SET_3Value;
            AOOutputVals[4] = lblG2SET_4Value;
            AOOutputVals[5] = lblSPARE_5Value;
            AOOutputVals[6] = lblSPARE_6Value;
            AOOutputVals[7] = lblSPARE_7Value;

            // Assign AO Output Text Vals
            txtAOOutputVals[0] = txtRFSET_0Val;
            txtAOOutputVals[1] = txtTNSET_1Val;
            txtAOOutputVals[2] = txtLDSET_2Val;
            txtAOOutputVals[3] = txtG1SET_3Val;
            txtAOOutputVals[4] = txtG2SET_4Val;
            txtAOOutputVals[5] = txtSPARE_5Val;
            txtAOOutputVals[6] = txtSPARE_6Val;
            txtAOOutputVals[7] = txtSPARE_7Val;

            // Assign TrackBar array
            AOTrackBarVals[0] = tBarRFSET_0Val;
            AOTrackBarVals[1] = tBarTNSET_1Val;
            AOTrackBarVals[2] = tBarLDSET_2Val;
            AOTrackBarVals[3] = tBarG1SET_3Val;
            AOTrackBarVals[4] = tBarG2SET_4Val;
            AOTrackBarVals[5] = tBarSPARE_5Val;
            AOTrackBarVals[6] = tBarSPARE_6Val;
            AOTrackBarVals[7] = tBarSPARE_7Val;

            // Assign AO Checkbox array
            AOChkRanges[0] = chbxRFSET_0Range;
            AOChkRanges[1] = chbxTNSET_1Range;
            AOChkRanges[2] = chbxLDSET_2Range;
            AOChkRanges[3] = chbxG1SET_3Range;
            AOChkRanges[4] = chbxG2SET_4Range;
            AOChkRanges[5] = chbxSPARE_5Range;
            AOChkRanges[6] = chbxSPARE_6Range;
            AOChkRanges[7] = chbxSPARE_7Range;
        ...
        public void cmdConnect_Click(System.Object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    AvantechAOs.Initialize(SystemGlobals.IP, SystemGlobals.AOSlotNum, Avantech.m_ScanTime_LocalSys[0]);//AvantechAOs.Initialize(IP, AOSlotNum, Avantech.m_ScanTime_LocalSys[0]);
                    MessageBox.Show("Fail to connect to Fieldbus! Please check the physical connection and MODBUS address setting!");
                }
            }
        }
        ...
        private void AvantechConnectTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Class1.DisconnectTimeElapsedSecs =
                        Convert.ToInt32(BGWConnectTimes*AvantechConnectTimer.Interval*0.001f);
                    ...
                    {
                        lblResumeConnectionInfo.Text = "More than 20 secs Auto Connect Time Elapsed! Please connect manually !";
                        AvantechConnectTimer.Stop();
                        BGWConnectTimerStart = false;
