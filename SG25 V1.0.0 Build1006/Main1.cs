...
namespace SG25
{
    public partial class Main1 : Form
    {
        ...
        int[] DOChannelArr = { 1, 12, 13, 20, 21, 22 }; //pump on(1), chamber up(12), chamber down(13), pressure on(20), vent on(21), vacuum on(22)
        int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25 }; //Gas1, Gas2
        // End of Animation
        int LastAlarm = 0;
        ...
        private void Main_Load(System.Object sender, System.EventArgs e)
        {
           ...
           // Gas3set.Text = Class1.Gas3T;
            ...
            AnimationThread = new Thread(new ThreadStart(AnimationThreadRun));
        ...
        private void AnimationThreadRun()
        {
            for (; ; )
            {
                if (IsAnimationStarted)
                {
                    ...
                    this.Invoke((MethodInvoker)delegate
                    {
                        ...
                        {
                            case 0:
                                StepPictures.Image = Properties.Resources.Step_0;
                                // DI
                                cmdPumpOk.BackColor = Color.Green;// pump ok(from Digital Input)
                                cmdTransferArmHome.BackColor = Color.Green;// TransferArmHome
                                cmdTransferCenter.BackColor = Color.Red;// TransferArmCenter
                                cmdTransferArmRemote.BackColor = Color.Red;// TransferArmRemote

                                // DO
                                //bool[] DOStateArr0 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr0);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                cmdVentingOn.BackColor = Color.Green;
                                cmdVacuumOn.BackColor = Color.Red;

                                //bool[] DIO_DOStateArr0 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr0);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Red;
                                cmdTraySenRight.BackColor = Color.Red;
                            ...
                            case 1:
                                ...
                                // DI
                                cmdPumpOk.BackColor = Color.Green;// pump ok(from Digital Input)
                                cmdTransferArmHome.BackColor = Color.Red;// TransferArmHome
                                cmdTransferCenter.BackColor = Color.Red;// TransferArmCenter
                                cmdTransferArmRemote.BackColor = Color.Green;// TransferArmRemote

                                // DO
                                //bool[] DOStateArr1 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr1);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25}; //Gas1, Gas2
                                //bool[] DIO_DOStateArr1 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr1);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Red;
                                cmdTraySenRight.BackColor = Color.Red;
                            ...
                            case 2:
                                ...
                                // DO
                                //bool[] DOStateArr2 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr2);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //bool[] DIO_DOStateArr2 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr2);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Green;
                                cmdTraySenRight.BackColor = Color.Green;
                            ...
                            case 3:
                                ...
                                // DO
                                //bool[] DOStateArr3 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr3);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //bool[] DIO_DOStateArr3 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr3);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Green;
                                cmdTraySenRight.BackColor = Color.Green;
                            ...
                            case 4:
                                ...
                                // DO
                                //int[] DOChannelArr = { 1,12,13,20,21,22 }; //pump on(1), chamber up(12), chamber down(13), pressure on(20), vent on(21), vacuum on(22)
                                //bool[] DOStateArr4 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr4);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25}; //Gas1, Gas2
                                //bool[] DIO_DOStateArr4 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr4);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Green;
                                cmdTraySenRight.BackColor = Color.Green;
                            ...
                            case 5:
                                ...
                                // DO
                                //int[] DOChannelArr = { 1,12,13,20,21,22 }; //pump on(1), chamber up(12), chamber down(13), pressure on(20), vent on(21), vacuum on(22)
                                //bool[] DOStateArr5 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr5);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25}; //Gas1, Gas2
                                //bool[] DIO_DOStateArr5 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr5);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Green;
                                cmdTraySenRight.BackColor = Color.Green;
                            ...
                            case 6:
                                ...
                                // DO
                                //int[] DOChannelArr = { 1,12,13,20,21,22 }; //pump on(1), chamber up(12), chamber down(13), pressure on(20), vent on(21), vacuum on(22)
                                //bool[] DOStateArr6 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr6);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25}; //Gas1, Gas2
                                //bool[] DIO_DOStateArr6 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr6);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Green;
                                cmdTraySenRight.BackColor = Color.Green;
                            ...
                            case 7:
                                ...
                                // DO
                                //int[] DOChannelArr = { 1,12,13,20,21,22 }; //pump on(1), chamber up(12), chamber down(13), pressure on(20), vent on(21), vacuum on(22)
                                //bool[] DOStateArr7 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr7);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25}; //Gas1, Gas2
                                //bool[] DIO_DOStateArr7 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr7);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Red;
                                cmdTraySenRight.BackColor = Color.Red;
                            ...
                            case 8:
                                ...
                                // DO
                                //int[] DOChannelArr = { 1,12,13,20,21,22 }; //pump on(1), chamber up(12), chamber down(13), pressure on(20), vent on(21), vacuum on(22)
                                //bool[] DOStateArr8 = { true, true, false, false, true, false };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr8);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Green;
                                cmdChamberDown.BackColor = Color.Red;
                                cmdPressureOn.BackColor = Color.Red;
                                ...
                                //int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25}; //Gas1, Gas2
                                //bool[] DIO_DOStateArr8 = { false, false };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr8);
                                cmdGas1.BackColor = Color.Red;
                                cmdGas2.BackColor = Color.Red;
                                cmdTraySenLeft.BackColor = Color.Red;
                                cmdTraySenRight.BackColor = Color.Red;
                            ...
                            case 9:
                                ...
                                // DO
                                //pump on(1), chamber up(12), chamber down(13), pressure on(20), vent on(21), vacuum on(22)
                                //bool[] DOStateArr9 = { true, false, true, true, false, true };
                                //Class2.SetMultiDO(DOChannelArr, DOStateArr9);
                                cmdPumpOn.BackColor = Color.Green;
                                cmdChamberUp.BackColor = Color.Red;
                                cmdChamberDown.BackColor = Color.Green;
                                cmdPressureOn.BackColor = Color.Green;
                                cmdVentingOn.BackColor = Color.Red;
                                cmdVacuumOn.BackColor = Color.Green;

                                //int[] DIO_DOChannelArr = { Class1.DO24, Class1.DO25}; //Gas1, Gas2
                                //bool[] DIO_DOStateArr9 = { true, true };
                                //Class2.SetMultiDIO(DIO_DOChannelArr, DIO_DOStateArr9);
                                cmdGas1.BackColor = Color.Green;
                                cmdGas2.BackColor = Color.Green;
                                cmdTraySenLeft.BackColor = Color.Red;
                                cmdTraySenRight.BackColor = Color.Red;
...
//            DoorsDownAutoTh();
      ...
      private void Button8_Click(System.Object sender, System.EventArgs e)
        ...
        if (Class1.SendAlarm != LastAlarm)
            ...
            catch { //MessageBox.Show("Downstream is busy why initializining the Cycle."); 
            }
        }
        ...
        private void TestThread()
        {
            ...
            do
            {
               ...
               if (Stopbtn .Visible == false & Startbtn .Visible ==false )
                ...
                //{
                //    cmdPumpOn.Invoke((MethodInvoker)delegate {cmdPumpOn.BackColor = Color.Red; });
                    
                //}
                //else
                //{
                //    cmdPumpOn.Invoke((MethodInvoker)delegate { cmdPumpOn.BackColor = Color.Green; });
                ...
                {
                    //cmdGas1.BackColor = Color.Red;// Button10.BackColor = Color.Black;
                    G1T.Invoke((MethodInvoker)delegate {G1T.Visible = true;G1XSAOff.Visible = true;G1XSAOn.Visible = false; });
                 }
                else
                {
                    //cmdGas1.BackColor = Color.Green;//Button10.BackColor = Color.Green;
        ...
        private void cmdTestDO_Click(object sender, EventArgs e)
        {
           // Class2.Create10DOArray(31, 1, 32, 0, 12, 1);
        ...
        private void G1XSAOn_Click(object sender, EventArgs e)
        {
