        ...
        private void TestThread()
        {
            ...
            do
            {
               ...
               if (Stopbtn .Visible == false & Startbtn .Visible ==false )
                ...
                if (Class1.DO_RFON == false)
                {
                    RF1.Invoke((MethodInvoker)delegate { RF1.BackColor = Color.Black; RFONpic.Visible = false; RFOFFpic.Visible = true; });
                }
                else
                {
                    RF1.Invoke((MethodInvoker)delegate { RF1.BackColor = Color.Red; RFOFFpic.Visible = false; RFONpic.Visible = true; });
                 }
               ...
               //}
                ...
                if (Class1.Gas3 == true)
                {
                    Gas3Cover.Invoke((MethodInvoker)delegate { Gas3Cover.Visible = false; Label17.Visible = true; Gas3set.Visible = true; Label45.Visible = true; });
                 }
                else
                {
                    Gas3Cover.Invoke((MethodInvoker)delegate { Gas3Cover.Visible = true; Label17.Visible = false; Gas3set.Visible = false; Label45.Visible = false; });
                }
