...
namespace SG25
{
    public static class Avantech
    {
        ...
        public static bool Avantech_AllFailCheckEnabled = true;
        public static bool bBGWConnectAvantech = false;
        ...
        //    FormWait.Start_Wait(1000);
        //    FormWait.ShowDialog();
        //    FormWait.Dispose();
        //    FormWait = null;
        //}
        public static void ShowWaitMsg1()
        {
            Wait_Form1 FormWait = new Wait_Form1();
            FormWait.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            FormWait.Start_Wait(5000);
            FormWait.ShowDialog();
            FormWait.Dispose();
            FormWait = null;
        }
        public static void ThreadStartShowWaitForm()
        {
        ...
        public static void AfterSelect_CouplerDevice(TreeNode e)
        {
            ...
            if (m_adamModbusSocket.Connect(AdamType.Apax5070, m_szIP, ProtocolType.Tcp))
            {
                ...
                Class2.WriteEventLog(Class1.ConnectionOkCode, Class1.ConnectionOkDesc);
                Class2.LogEventDB(Class1.ConnectionOkCode, Class1.ConnectionOkDesc);

                if (m_adamModbusSocket.RefreshIOInfo())
                {
                    //ThreadStart newStart = new ThreadStart(ShowWaitMsg1);
                    //Thread waitThread = new Thread(ShowWaitMsg1);
                    //waitThread.Start();
                    //ShowWaitMsg();
